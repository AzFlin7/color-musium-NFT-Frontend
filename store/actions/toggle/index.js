...
export const Connector = (payload) => ({
  type: CONNECTOR,
  payload: payload,
});
export const FooterOnView = (payload) => ({
  type: FOOTER_ON_VIEW,
  payload: payload,
});
...
export const PendingConnect = (payload) => ({
  type:PENDINGCONNECT,
  payload: payload
});
...
export const PriceToMintUsd = (payload) => ({
  type: PRICETOMINTUSD,
  payload: payload,
});
...
export const OnPinChecked = (payload) => ({
  type: PINISCHECKED_TOGGLE,
  payload: payload,
});
