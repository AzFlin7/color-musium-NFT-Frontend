        ...
        <div className={styles.profileTab}>
          <Tabs className={styles.reactTabs}>
              ...
              <div className={styles.settingMenu}>
                ...
                <TabList className={styles.tabList}>
                  <Tab
                    ...
                    selectedClassName={styles.tabsTab_selected}
                  >
                    <p>Profile</p>
                  </Tab>
                  <Tab
            ...
            <div className={styles.rightTab}>
              <TabPanel
                className={styles.tabsTab_panel}
                selectedClassName={styles.tabsTab_panel_selected}
              >
                  ...
                  <div className={styles.profileWallet}>
                    ...
                    <div className={styles.profileBGContent}>
                      ...
                      <div className={styles.profileFlexContent}>
                        <div className={styles.leftWallet}>0 ETH</div>
                    ...
                    <div className={styles.profileBGContent}>
                      ...
                      <div className={styles.profileFlexContent}>
                        <div className={styles.switchItem}>
                          ...
                          >
                            <p>
                              Receive email notifications when bids you place
                              are confirmed, when you have been outbid, and when
                    ...
                    <div className={styles.profileBGContent}>
                      ...
                      <div className={styles.profileFlexContent}>
                        <div className={styles.switchItem}>
                          ...
                          >
                            <p>
                              Receive email notifications when someone buys your
                              FT and when you buy an NFT via Buy Now.
                            </p>
                            <Switch
