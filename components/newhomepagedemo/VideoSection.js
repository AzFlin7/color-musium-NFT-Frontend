...
import styles from "../../styles/modules/newhomepagedemo/videoSection.module.css";
...
const VideoSection = () => {
  ...
  const opts = {
    ...
    width: '100vh',
    playerVars: {
      autoplay: isEnter ? 1 : 0,
      controls: videoTime > 15 ? 1 : 0,
      rel: 0,
      listType: 'playlist',
    }
  };
              ...
              <>
                {isEnter && (
                  <div className={styles.mobileVideo}>
                    ...
                    <div className="youtubeVideoHomepage"
                      style={{
                        paddingTop: '0',
                      }}>
