...
const AcceptOrderBox = ({ hideModal, item, color }) => {
  ...
  const approveNFT = async () => {
    ...
    var ownerOfToken = await NFTInstance.methods
    ...
    var isNFTApprovedForAll = await NFTInstance.methods
      .isApprovedForAll(ownerOfToken, ERC721OrderFeatureAddress)
      .call();
          ...
          <div className={styles.InnerWrapper}>
            <section className={styles.container}>
              <div className={styles.InnerWrapper}>
                ...
                <p>
                  color:<a style={{ textTransform: 'uppercase' }}>{color}</a>
                </p>
