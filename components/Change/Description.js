...
import { NEXT_PUBLIC_OPENAI_API_KEY } from '../../utils/constants';
  ...
  return (
    <>
      <article
        ...
        style={{ minHeight: 'calc(((113vh - 90px) - 60px) - 124px)' }}
      >
        <div style={{ paddingBottom: '2rem' }}>
          ...
          <form onSubmit={handleSubmit}>
            <input
              ...
              onChange={(e) => {
                setInputtDescription(e.target.value);
                setReceivedColorDesc(e.target.value);
              }}
      ...
      <div
        ...
        style={{ backgroundColor: `${receivedColor}`, height: '128vh' }}
      >
