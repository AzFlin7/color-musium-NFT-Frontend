    ...
    if (nftNumber) {
      const handleData = async () => {
        ...
        try {
          ...
          formdata.append(
            "external_url",
            `https://color.museum/gallery/color-nft/${
              hexToNumber
                ? hexToNumber
  ...
  return (
    <>
      <div className={stylesName.text_container}>
        ...
        <Link href={`/gallery/color-nft/${hexToNumber}`} passHref>
          <a className={styles.button} style={{ width: "300px" }}>
            View Color
          </a>
        </Link>
